  ...
  class PropertyAccessors extends superClass {
    ...
    _attributeToProperty(attribute, value, type) {
      ...
      if (!this.__serializing) {
        let property = caseMap$1.dashToCamelCase(attribute);
    ...
    _propertyToAttribute(property, attribute, value) {
      ...
      this._valueToNodeAttribute(this, value,
        attribute || caseMap$1.camelToDashCase(property));
      this.__serializing = false;
    }
  ...
  class PolymerElement extends polymerElementBase {
    ...
    _initializeProperties() {
      ...
      if (this._template && !this._template.__polymerFinalized) {
        ...
        const baseURI =
          importPath ? resolveUrl(importPath) : '';
...
function _add(node, evType, handler) {
  let recognizer = gestures$1[evType];
...
function register$1(recog) {
  ...
  for (let i = 0; i < recog.emits.length; i++) {
    gestures$1[recog.emits[i]] = recog;
  }
}
...
if (document.readyState === 'interactive' || document.readyState === 'complete') {
  ...
  window.addEventListener('DOMContentLoaded', resolve$1);
}
...
const LegacyElementMixin = dedupingMixin((base) => {
  ...
  class LegacyElement extends legacyElementBase {
    ...
    */
    ...
    getEffectiveChildNodes() {
      return (
        /** @type {Polymer.DomApi} */ (dom(this)).getEffectiveChildNodes()
      );
    }
    ...
    queryDistributedElements(selector) {
      return (
        /** @type {Polymer.DomApi} */ (dom(this)).queryDistributedElements(selector)
      );
    }
 ...
 * @unrestricted
 */
class TemplateInstanceBase$1 extends base {
  constructor(props) {
    super();
...
/** @type {!DataTemplate} */
TemplateInstanceBase$1.prototype.__dataHost;
/** @type {!TemplatizeOptions} */
TemplateInstanceBase$1.prototype.__templatizeOptions;
/** @type {!Polymer_PropertyEffects} */
TemplateInstanceBase$1.prototype._methodHost;
/** @type {!Object} */
TemplateInstanceBase$1.prototype.__templatizeOwner;
/** @type {!Object} */
TemplateInstanceBase$1.prototype.__hostProps;
 ...
 * @implements {Polymer_MutableData}
 */
const MutableTemplateInstanceBase = MutableData(TemplateInstanceBase$1);
...
function createTemplatizerClass(template, templateInfo, options) {
  ...
  let base = options.mutableData ?
    MutableTemplateInstanceBase : TemplateInstanceBase$1;
  /**
   * @constructor
   * @extends {base}
   */
 ...
 */
function processImage$1(image, props, ROOT) {
  const {
    resize,
    quality,
    greyscale,
...
(self || window).processImage = processImage$1;
